                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i>Entry From</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="ClassStudents.php">Class Students<span class="badge badge-secondary">New</span></a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-fw fa-chart-pie"></i>Reports</a>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>Accounts Setup</a>
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/bootstrap-select.php">Cash Received Voucher</a>
                                        </li>
										<li class="nav-item">
                                            <a class="nav-link" href="pages/bootstrap-select.php">Bank Received Voucher</a>
                                        </li>
										<li class="nav-item">
                                            <a class="nav-link" href="pages/bootstrap-select.php">Journal Voucher</a>
                                        </li>
										<li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Accounts Reports</a>
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/general-table.php">Voucher</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/data-tables.php">Day Books</a>
											<ul class="nav flex-column">
											<li class="nav-item">
												<a class="nav-link" href="pages/general-table.php">Cash Books</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="pages/general-table.php">Bank Books</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="pages/general-table.php">Journal Books</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="pages/general-table.php">Seles Books</a>
											</li>
											</ul>
                                        </li>
										<li class="nav-item">
                                            <a class="nav-link" href="pages/general-table.php">Ledger</a>
                                        </li>
										<li class="nav-item">
                                            <a class="nav-link" href="pages/general-table.php">Balance Sheet Statement</a>
                                        </li>
										<li class="nav-item">
                                            <a class="nav-link" href="pages/general-table.php">Monthly Wise Expenses Summary</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
