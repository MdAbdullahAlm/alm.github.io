...
if($pass == $re_pass){
   $sql="INSERT INTO tbreginfo( `User_Name`, `email`, `Password`, `RePassword`, `UserIp`, `entryTime`) VALUES ('$userName','$email','$pass','$re_pass','$userIp',CURRENT_TIMESTAMP)";
}
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form" action="reg.php" method="post>
